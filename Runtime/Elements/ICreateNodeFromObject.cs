...
namespace GraphProcessor
{
    ...
    public interface ICreateNodeFrom<in T> where T : Object
    {
	    /// <summary>
	    ...
	    /// </summary>
	    /// <param name="graph">The graph this node will be added to.</param>
	    ...
	    bool InitializeNodeFromObject(BaseGraph graph, T value);
    }
}